...
// Chỉ dùng scope CƠ BẢN (openid email profile) — KHÔNG cần Google xác minh app.
// Scope nhạy cảm như user.gender.read khiến consent screen bị chặn (403
// access_denied / "app đang kiểm thử") khi app chưa qua xác minh Google, nên
// KHÔNG lấy giới tính từ Google — người dùng tự chọn giới tính khi đăng ký / ở
// trang Hồ sơ.
